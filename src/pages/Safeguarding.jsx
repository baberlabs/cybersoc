    ...
    <main id="main" className="container text-white max-w-5xl">
      ...
      <section className="space-y-6 text-white/85 leading-relaxed">
        ...
        <ul className="list-disc ml-6 space-y-2">
          ...
          <li>Blackmail, coercion, or safeguarding concerns</li>
        </ul>

        <h2 className="text-2xl font-bold">Reporting</h2>
        <p>
          Safeguarding issues may be reported to any committee member or
          directly through BCUSU safeguarding services. Reports are handled
          confidentially and with priority.
        </p>
      </section>
    </main>
  );
